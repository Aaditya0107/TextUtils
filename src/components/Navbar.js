          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <NavLink className="nav-link active" aria-current="page" style={location.pathname === "/" ? props.activeStyle : null} to="/" >Home</NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" style={location.pathname === "/about" ? props.activeStyle : null} to="/about">{props.About}</NavLink>
              </li>
            </ul>
